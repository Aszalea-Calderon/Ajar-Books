...
| ☐    | Restyle the status dropdown (Want to Read / Currently Reading / Finished / DNF) to match the rest of the platform's control styling (pills/buttons elsewhere) instead of a plain `<select>`                                                                                             |
